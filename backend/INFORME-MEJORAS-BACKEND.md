...
- [~] **Payloads de endpoints + UX de redes lentas (2026-06-27).** Auditoría del hot path + primer batch HECHO:
  ...
  - **[~] UX redes lentas:**
    ...
    - **[ ] Pendiente:** estados de **error con botón de reintento** en `ClientDashboard`/`ProviderDashboard` (hoy tienen skeleton de carga pero no `ErrorState` si una query falla/vence).
